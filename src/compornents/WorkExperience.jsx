...
const experiences = [
  {
    title: "Web制作",
    date: "2024-現在 | 岩手県",
    desc: "個人でWeb制作を請け負っています。個人事業主様や、これから事業を立ち上げる方のWebサイト制作を担当しました。制作の流れをご説明したうえで、ZOOMで打ち合わせを重ねながら、デザイン制作・実装・修正対応まで一貫して行っています。また、友人からの依頼でshopifyを用いたECサイトも制作しました。その他Next.jsのフロントエンドの個人開発にも力を入れ、Webアプリ「Saving-UP」を完成させました。",
  },
  {
    title: "農業スタッフ",
